...
export const teacherSchema = z.object({
  ...
  username: z
    .string()
    .min(3, { message: "Username must at least 3 character long!" })
    .max(20, { message: "Username must at most 20 character long!" }),
  password: z
    .string()
  ...
  birthday: z.coerce.date().min(1, { message: "Birthday name is required!" }),
